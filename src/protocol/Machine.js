...
function _prep_ordered_arg(desired_length, arguments = null) {
  arguments = arguments !== null ? toArray(arguments) : [null];
  if (arguments.length != desired_length && arguments.length != 1) {
    throw new Error(
      'Argument length must be either 1 or the same length as the number of transitions.'
    );
  }
